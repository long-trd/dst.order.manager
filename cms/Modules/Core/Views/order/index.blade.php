                    ...
                    <div class="btn-search left-element">
                        ...
                        @if (auth()->user()->hasRole('admin'))
                            <button class="btn btn-warning text-white" data-toggle="modal"
                                    data-target="#modal-excel">Download Excel
                            </button>
                        @endif
                        <button id="btn-order-detail" class="btn btn-info text-white" data-toggle="modal"
                                data-target="#modal-form-detail" style="display: none">Detail
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="sort" data-sort="order_date" style="display: none">Order Date
                                </th>
                                <th scope="col" class="sort" data-sort="customer_notes" style="display: none">Customer
                                    Notes
                                </th>
                    ...
                    <div class="card-footer py-4 position-relative">
                        ...
                        <div class="sumup">Percentage of orders:
                            <b>{{ $totalOrderWithoutStatus ? round($totalOrderByQuery / $totalOrderWithoutStatus * 100, 2) : 0 }}
                                %</b></div>
                        <div class="sumup">Percentage of orders amount:
                            <b>{{ $totalAmountWithoutStatus ? round($totalAmountByQuery / $totalAmountWithoutStatus * 100, 2) : 0 }}
                                %</b></div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <textarea class="form-control"
                                                                  name="random-search"> {{ isset($request['random-search']) ? $request['random-search'] : '' }} </textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <input class="form-control" name="branch"
                                                               value="{{ isset($request['branch']) ? $request['branch'] : '' }}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <select class="form-control" data-toggle="select"
                                                            ...
                                                            <option
                                                                value="tiktok" {{ isset($request['network']) && $request['network'] == 'tiktok' ? 'selected' : '' }}>
                                                                Tiktok
                                                            </option>
                                                            <option
                                                                value="facebook" {{ isset($request['network']) && $request['network'] == 'facebook' ? 'selected' : '' }}>
                                                                Facebook
                                                            </option>
                                                        </select>
                                                    </div>
                                        ...
                                        <form id="form-detail" role="form" action="" method="POST">
                                            ...
                                            @if(auth()->user()->hasRole('admin'))
                                                <div class="form-group">
                                                    <label class="form-control-label"
                                                           for="input-name">{{ __('Shipper') }}</label>
                                                    @foreach($shippers as $key => $shipper)
                                                        <div class="custom-control custom-radio mb-3">
                                                            <input
                                                                {{ isset($order) && $shipper->id == $order->shipping_user_id ? 'checked' : '' }} name="shipping_user_id"
                                                                value="{{$shipper->id}}" class="custom-control-input"
                                                                id="shipper-{{$key}}" type="radio">
                                                            <label class="custom-control-label"
                                                                   for="shipper-{{$key}}">{{$shipper->name}}</label>
                                                        </div>
                                                    @endforeach
                                                </div>
                                            @endif
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="custom-control custom-radio mb-3">
                                                    ...
                                                    <label class="custom-control-label"
                                                           for="customRadio6">Shipped</label>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-control-label"
                                                       for="input-email">{{ __('Shipping Information') }}</label>
                                                <textarea name="shipping_information" class="form-control w-90" rows="3"
                                                          required></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-control-label"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="customer_notes" class="form-control w-90" rows="3"
                                                          required></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-control-label"
                                            ...
                                            <div class="form-group">
                                                <div class="custom-control custom-checkbox mb-3">
                                                    ...
                                                    <label class="custom-control-label"
                                                           for="customCheck1">Helping</label>
                                                </div>
                                            </div>
                                            @if (auth()->user()->hasRole('admin') || auth()->user()->hasRole('shipper'))
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="paypal_notes" class="form-control w-90"
                                            ...
                                            <form role="form" action="{{ route('admin.order.excel') }}"
                                                ...
                                                <div class="ml-1 row form-group">
                                                    <div class="col-md-2 custom-control custom-checkbox">
                                                        ...
                                                        <label class="custom-control-label"
                                                               for="customCheck0">Date</label>
                                                    </div>
                                                    <div class="col-md-2 custom-control custom-checkbox">
                                                        <input type="checkbox" name="option[]" value="price"
                                                               class="custom-control-input"
                                                               id="customCheck2">
                                                        <label class="custom-control-label"
                                                               for="customCheck2">Price</label>
                                                    </div>
                                                    <div class="col-md-2 custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input"
                                                               id="customCheck3" name="option[]" value="quantity">
                                                        <label class="custom-control-label"
                                                               for="customCheck3">Quantity</label>
                                                    </div>
                                                    <div class="col-md-2 custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input"
                                                               id="customCheck4" name="option[]" value="shipper">
                                                        <label class="custom-control-label"
                                                               for="customCheck4">Shipper</label>
                                                    </div>
                                                    <div class="col-md-2 custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input"
                                                               id="customCheck5" name="option[]" value="list">
                                                        <label class="custom-control-label"
                                                               for="customCheck5">List</label>
                                                    </div>
                                                </div>
