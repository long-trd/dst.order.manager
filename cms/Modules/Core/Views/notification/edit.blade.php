            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <form method="post" action="{{ route('admin.notification.update', ['id' => $notification->id]) }}" autocomplete="off">
                            @csrf
                            @if (count($errors) > 0)
                            ...
                            <div class="pl-lg-4 pd-left-25" id="form-group-wrapper">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="content" id="content" class="form-control form-control-alternative w-90" required>{{ old('content', $notification->content) }}</textarea>
